...
const styles$4 = {
  container: {
    flex: 0,
    flexDirection: I18nManager.isRTL && "android" === 'ios' ? 'row-reverse' : 'row',
    alignItems: 'center'
  }
};
...
const Pagination = ({
  ...
  const isLastPage = I18nManager.isRTL && "android" == 'ios' ? currentPage === 0 : currentPage + 1 === numPages;
  ...
  constructor(props) {
    ...
    _defineProperty(this, "goNext", () => {
      this.flatList.scrollToIndex({
        animated: true,
        index: I18nManager.isRTL && "android" == 'ios' ? this.state.currentPage - 1 : this.state.currentPage + 1
      });
    });
